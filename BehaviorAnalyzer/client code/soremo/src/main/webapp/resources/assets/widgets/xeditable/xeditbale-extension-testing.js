...
(function($) {
	...
	$.extend(Address.prototype, {
		...
		/**
		 * Default method to show value in element. Can be overwritten by
		 * display option.
		 * 
		...
		html2value : function(html) {
			 ...
			 * "Moscow, st. Lenina, bld. 15" => {city: "Moscow", street:
			 * "Lenina", building: "15"} but for complex structures it's not
			 * recommended. Better set value directly via javascript, e.g.
			 * editable({ value: { city: "Moscow", street: "Lenina", building:
			 * "15" } });
			 */
			return null;
		},
		...
		str2value : function(str) {
			 ...
			 * If you will always set value by javascript, no need to overwrite
			 * it
			 */
			return str;
		},
